...
<div class="sidebar fl">
	<h3>Contact us</h3>
	<ul class="list">
		<li><a class="cur" href="<%=request.getContextPath() %>/index/contact/location">Location</a></li>
		<li><a class="" href="<%=request.getContextPath() %>/index/contact/feedback">Online Feedback</a></li>
	</ul>
