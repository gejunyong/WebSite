...
<div class="sidebar fl">
	<h3>Service</h3>
	<ul class="list">
		<li><a class="" href="<%=request.getContextPath() %>/index/service/salesmap">Sales Map</a></li>
		<li><a class="cur" href="<%=request.getContextPath() %>/index/about/ourculture">Service Team</a></li>
	</ul>
