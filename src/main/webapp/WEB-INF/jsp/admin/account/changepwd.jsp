...
<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Chanage Password</li>
						</ul><!-- /.breadcrumb -->
			...
			<form method="post"  enctype="multipart/form-data">
				    ...
				    <td>
				    <input name="pwd_old" type="password" style="width:400px"/>
				    </td>
				    </tr>
				    				    <tr>
				    <td style="font-size: large;">new Password</td>
				    <td>
				    <input name="pwd_new"  type="password"  style="width:400px"/>
				    </td>
				    </tr>
				    <tr>
				    <td style="font-size: large;">new Password again </td>
				    <td>
				    <input name="pwd_new1"  type="password"  style="width:400px"/>
				    </td>
				    </tr>
					<tr><td><span style="color:red">${error }</span></td>
					<td>
