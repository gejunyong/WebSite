...
<script type="text/javascript" charset="utf-8"
	src="<%=request.getContextPath()%>/resources/utf8-jsp/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8"
	src="<%=request.getContextPath()%>/resources/utf8-jsp/ueditor.all.min.js"></script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script type="text/javascript" charset="utf-8"
	src="<%=request.getContextPath()%>/resources/utf8-jsp/lang/zh-cn/zh-cn.js"></script>
		...
		<div class="main-content-inner">
			...
			<sf:form method="post" modelAttribute="t"
				...
				<table class="table">
					...
					<tr>
						<td>content:</td>
						<td><sf:textarea id="editor" path="content" type="text/plain"
								style="width:748px;height:400px;"></sf:textarea></td>
					</tr>
					<tr>
